...
public class EventView extends JFrame implements ComponentListener, MouseListener, KeyListener{
	...
	JPanel eventPanel, listPanel, eventViewPanel, buttonPanel, participantPopPanel;
	JLabel dash;
	DateTimePicker calendarToPopPanel, calendarFromPopPanel;
	...
	String toHour, toMinute, fromHour, fromMinute, toDate, fromDate;
